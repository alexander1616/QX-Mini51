      ...
      000000                        264 	.ds 8
                                    ...
                                    327 	.area CSEG    (CODE)
                                    328 ;------------------------------------------------------------
                                    329 ;Allocation info for local variables in function 'readButton'
                                    330 ;------------------------------------------------------------
                                    331 ;button                    Allocated to registers r7 
                                    332 ;------------------------------------------------------------
                                    333 ;	buttonPress.c:4: unsigned char readButton(){
                                    334 ;	-----------------------------------------
                                    335 ;	 function readButton
                                    336 ;	-----------------------------------------
      000229                        337 _readButton:
                           000007   338 	ar7 = 0x07
                           000006   339 	ar6 = 0x06
                           000005   340 	ar5 = 0x05
                           000004   341 	ar4 = 0x04
                           ...
                           000001   344 	ar1 = 0x01
                           000000   345 	ar0 = 0x00
                                    346 ;	buttonPress.c:6: button = 0;
      000229 7F 00            [12]  347 	mov	r7,#0x00
                                    348 ;	buttonPress.c:7: if (P3_2 == 0){
      00022B 20 B2 04         [24]  349 	jb	_P3_2,00110$
                                    350 ;	buttonPress.c:8: button = 4;
      00022E 7F 04            [12]  351 	mov	r7,#0x04
      000230 80 13            [24]  352 	sjmp	00111$
      000232                        353 00110$:
                                    354 ;	buttonPress.c:9: } else if (P3_3 == 0){
      000232 20 B3 04         [24]  355 	jb	_P3_3,00107$
                                    356 ;	buttonPress.c:10: button = 3;
      000235 7F 03            [12]  357 	mov	r7,#0x03
      000237 80 0C            [24]  358 	sjmp	00111$
      000239                        359 00107$:
                                    360 ;	buttonPress.c:11: } else if (P3_4 == 0){
      000239 20 B4 04         [24]  361 	jb	_P3_4,00104$
                                    362 ;	buttonPress.c:12: button = 2;
      00023C 7F 02            [12]  363 	mov	r7,#0x02
      00023E 80 05            [24]  364 	sjmp	00111$
      000240                        365 00104$:
                                    366 ;	buttonPress.c:13: } else if (P3_5 == 0){
      000240 20 B5 02         [24]  367 	jb	_P3_5,00111$
                                    368 ;	buttonPress.c:14: button = 1;
      000243 7F 01            [12]  369 	mov	r7,#0x01
      000245                        370 00111$:
                                    371 ;	buttonPress.c:16: return button;
      000245 8F 82            [24]  372 	mov	dpl,r7
                                    373 ;	buttonPress.c:17: }
      000247 22               [24]  374 	ret
                                    375 	.area CSEG    (CODE)
                                    376 	.area CONST   (CODE)
                                    377 	.area XINIT   (CODE)
